...
const SearchInput = () => {
	...
	return (
		<form onSubmit={handleSubmit} className='flex items-center gap-6 mt-3'>
			<input
				type='text'
				placeholder='Search…'
				className='input input-bordered rounded-full w-60 placeholder:text-slate-400 text-lg px-6'
				value={search}
