	...
	return (
		<div className='flex flex-col items-center justify-center min-w-[450px] mx-auto'>
			<div className='w-full p-6 px-7 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				<h1 className='text-3xl font-semibold text-center text-gray-300 mb-7'>
					Sign Up <span className='text-[#3ea091]'> WebChat</span>
				</h1>

				<form onSubmit={handleSubmit}>
					<div>
						<label className='label p-2 py-0'>
					...
					<Link
						to={"/login"}
						className='text-sm hover:underline hover:text-blue-600 mt-2 inline-block pt-6'
						href='#'
					>
